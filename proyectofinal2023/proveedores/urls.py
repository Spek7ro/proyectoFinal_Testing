...
urlpatterns = [
    ...
    path('editar/<int:pk>', views.EditarProveedor.as_view(),
         name='editar_proveedor'),
    path('eliminar/<int:pk>', views.EliminarProveedor.as_view(),
         name='eliminar_proveedor'),
    path('eliminar-proveedores', views.eliminar_proveedores,
