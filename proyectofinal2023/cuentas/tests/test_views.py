...
class ViewsTestCase(TestCase):
    def setUp(self):
        ...
        # Crear instancias de Municipio asociadas al Estado creado anteriorment
    ...
    def test_eliminar_cuenta_view(self):
        response = self.client.post(
            reverse('eliminar_cuenta', args=[self.cuenta.idcuenta]))
        self.assertEqual(response.status_code, 302)
        self.assertEqual(CuentaBancaria.objects.count(), 1)
    ...
    def test_editar_cuenta_view(self):
        ...
        response = self.client.post(
            reverse('editar_cuenta', args=[self.cuenta.idcuenta]), data)
        self.assertEqual(response.status_code, 302)
